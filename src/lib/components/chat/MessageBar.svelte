...
<form
  ...
  class="absolute bottom-0 z-40 flex h-fit w-full gap-2 bg-white border-t-2 lg:border-2 lg:border-b-0 lg:border-black/10 p-3 shadow-[0_0_8px_rgba(0,0,0,.125)] lg:left-[20%] lg:w-[60%] lg:rounded-t-2xl dark:bg-zinc-950 dark:border-white/10"
>
  ...
  <Dialog bind:open={$settingsDialogOpen} onOpenChange={()=>{
